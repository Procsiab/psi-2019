...
\chapter{Distribuzioni notevoli}
    ...
    \section{Distribuzioni derivate dalla Normale}
        \subsection{Distribuzione Chi-Quadro}
            ...
            \begin{defn}[Definizione alternativa]
                La densità Gamma di parametri $\alpha = n /2$ e $\lambda = 1 /2$  con $n \geq 1$ intero, è anche indicata come densità \textit{chi-quadro} con $n$ gradi di libertà.
            ...
            \end{defn}
        \subsection{Distribuzione \textit{t}}
            \begin{defn}
            ...
            \begin{proof}
                ...
                \end{enumerate}
            \end{proof}
        \subsection{Distribuzione \textit{F}}
        \begin{defn}
            ...
            ,\end{equation}
            ha una distribuzione chiamata \textit{F di Fisher} con $n$ e $m$ gradi di libertà, e la indichiamo con: \[
    ...
    \section{Quantili}
        \begin{defn}
            Chiamiamo \textit{quantile} di ordine $\alpha$, e lo indichiamo con $q_\alpha$ per 
        ...
        \subsection{Quantili della chi-quadro}
            \begin{defn}
                ...
                .\]
            \end{defn}
        \subsection{Quantili della \textit{t}}
            \begin{defn}
            ...
            \end{defn}
            \begin{obsv}
                Data la simmetria della densità \textit{t} rispetto all'asse $x=0$, possiamo scrivere:
                \begin{align*}
                ...
                .\end{equation}
            \end{obsv}
        \subsection{Quantili della \textit{F}}
            \begin{defn}
