...
\chapter{Variabili Aleatorie}
    ...
    \section{Densità continue notevoli}
        \subsection{Uniforme}
            \begin{defn}\label{defn:Densità_uniforme}
                ...
                .\]
            \end{defn}
        \subsection{Esponenziale}\label{sec:Densità_Esponenziale}
            \begin{defn}
        ...
        \subsection{Gaussiana}
            ...
            \begin{defn}\label{defn:Gaussiana}
                ...
                .\] 
            \end{defn}
    \section{Funzioni di variabili aleatorie}\label{sec:Funzioni_variabili_aleatorie}
    ...
    \section{Varianza}\label{sec:Varianza}
        \begin{defn}\label{defn:Varianza}
            ...
            ;\] chiamiamo \emph{varianza} di $X$ la quantità $\text{Var}(X)$, mentre la sua radice quadrata $\sqrt{\text{Var}(X)}$ prende il nome di \emph{deviazione standard}.
        \end{defn}
        \begin{obsv}
    ...
    \section{Momenti}
        ...
        \end{proof}
    \section{Tempi di vita}
    \begin{defn}[Tempo di vita]\label{defn:Tempi_di_vita}
        ...
        \begin{prty}\label{prty:Tempi_di_vita}
            ...
            \end{enumerate}
        \end{prty}
        \begin{defn}[Intensità di rottura]
        ...
        \begin{obsv}
            ...
            .\end{align*}
        \end{obsv}
    \section{Distribuzione di Weibull}
        ...
        \begin{obsv}
            ...
            .\] 
        \end{obsv}
        \begin{defn}[Weibull generalizzata]
