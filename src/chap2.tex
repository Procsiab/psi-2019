    ...
    \section{Densità continue notevoli}
        ...
        \subsection{Esponenziale}
           ...
           \end{equation}
            ...
            .\]
            \end{defn}
        \subsection{Normale (o Gaussiana) Standard}
            \begin{defn}
    ...
    \begin{defn}[discreto]\label{defn:Valore_atteso_discreto}
        ...
        \begin{prty}\label{prty:Valore_atteso}
            ...
            \begin{enumerate}
                ...
                \item sia $X$ una variabile aleatoria che ammette valore atteso $\text{E}(X)$ e $\alpha$ una costante, allora vale: $\text{E}(\alpha \cdot X) = \alpha \cdot \text{E}(X)$ (\textit{linearità});
                \item sia $X$ una variabile aleatoria e $g(),\, h()$ due funzioni tali che esistano i loro valori attesi $\text{E}(g(X)),\, \text{E}(h(X))$; allora vale: $\text{E}(g(X)+h(X)) = \text{E}(g(X)) + \text{E}(h(X))$ (\textit{linearità});\label{itm:Linearità_valore_atteso}
